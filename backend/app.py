# -*- coding: utf-8 -*-
# backend/app.py
# This file implements a Flask backend service that provides API endpoints for interacting with the Ollama language model
      ...
      - name: message
        ...
        schema:
          ...
          properties:
            ...
            use_rag:
              type: boolean
              description: Whether to use RAG for response generation
    responses:
      200:
        description: AI response
      400:
        description: Request missing 'message' field
      500:
...
def add_document():
    """
    Add Document API with vector generation
    ---
    tags:
      - Documents
    parameters:
...
def update_embeddings():
    """
    Force update embeddings for all chunks
    ---
    tags:
      - Admin
    responses:
