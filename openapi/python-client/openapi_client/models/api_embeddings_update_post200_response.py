...
class ApiEmbeddingsUpdatePost200Response(BaseModel):
    """
    ApiEmbeddingsUpdatePost200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    total_chunks: Optional[StrictInt] = None
    embedded_chunks: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["message", "total_chunks", "embedded_chunks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "embedded_chunks": obj.get("embedded_chunks")
        })
        return _obj
